...
#
# Работу самих валидаций не надо тестировать (это работа
...
RSpec.describe Question, type: :model do
  ...
  # тест на валидацию уникальности текста вопроса в файле
  context 'validate uniqueness of question text' do
    subject { Question.new(text: 'some', level: 0,
